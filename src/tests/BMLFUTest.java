 ...
 */
class BMLFUDriver extends TestDriver implements GlobalConst {
  ...
  public boolean runTests () {
    ...
    try {
      //# of pages = 70, buffer pool = 50
      SystemDefs sysdef = new SystemDefs( dbpath, NUMBUF+20, NUMBUF, "LFU" );
    }
...
public class BMLFUTest {

   public static void main (String argv[]) {

     BMLFUDriver bmt = new BMLFUDriver();
     boolean dbstatus;
