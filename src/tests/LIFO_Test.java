...
class BMDriver extends TestDriver implements GlobalConst {
  ...
  public boolean runTests () {
    ...
    try {
      SystemDefs sysdef = new SystemDefs( dbpath, NUMBUF+20, NUMBUF,"LIFO" );
    }
  ...
  protected String testName () {
    return "Buffer Management - LIFO";
  }
}

public class LIFO_Test {
   ...
   public static void main (String argv[]) {
     ...
     if (dbstatus != true) {
       System.err.println ("Error encountered during buffer manager LIFO tests:\n");
       Runtime.getRuntime().exit(1);
     }
