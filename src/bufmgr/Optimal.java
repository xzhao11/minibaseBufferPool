...
import global.*;
  ...
  /**
   * class Optimal is a subclass of class Replacer using Optimal
   * algorithm for page replacement
   */
class Optimal extends  Replacer {
...
/* public methods */
 ...
 public void pin(int frameNo) throws InvalidFrameNumberException
 {
   ...
   * or choosing a page to replace using Optimal policy
   *
 ...
 public void info()
 {
    ...
    System.out.print( "Optimal REPLACEMENT");
